...
fixed_seed = np.random.normal(0, 1, (PREVIEW_ROWS * PREVIEW_COLS, NOISE_SIZE))
cnt = 1
...
for epoch in range(EPOCHS):
    ...
    seed = np.random.normal(0,1,(BATCH_SIZE,NOISE_SIZE))
    ...
    break
# generator.save("motorbike_generator.h5")
